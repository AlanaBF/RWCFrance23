...
const Teams = () => {
  ...
  //filter it by name for each name on pools.teams

  

  // const argentina = data.filter((team) => (team.home = 'France'));
  // //'2023-09-08T19:00:00+00:00'
  // const currentDate = new Date('1/10/2024');
  // console.log(moment(currentDate).format('D/M/YYYY'));
  // argentina.map(t => moment(t.date).format('D/M/YYYY'));
  // const closestToDate = (y) => {
  //   y.map(z => {
  //     moment(z.date).format('D/M/YYYY');
  //     z.filter(z.date === currentDate);
  //     return z.date
  //   });
  // }
  // closestToDate(argentina);
